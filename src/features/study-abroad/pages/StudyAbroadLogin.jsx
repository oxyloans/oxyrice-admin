    ...
    try {
      ...
      if (response.data?.status === "Login Successful") {
        ...
        if (primaryType === "HELPDESKSUPERADMIN") {
          ...
          setTimeout(() => {
            const redirect =
              localStorage.getItem("redirectAfterLogin_studyabroad") ||
              "/studyabroad/studentapplications";
            localStorage.removeItem("redirectAfterLogin_studyabroad");
            navigate(redirect);
          }, 1000);
        } else {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="text-center mb-8 transform hover:scale-105 transition-transform duration-300">
        <h1 className="text-5xl font-bold tracking-tight">
          <span className="text-[#008cba]">Study Abroad</span>
        </h1>
      ...
      <div className="mt-8 text-center text-gray-500 text-sm">
        <p>© {new Date().getFullYear()} ASKOXY.AI - Study Abroad Admin</p>
      </div>
