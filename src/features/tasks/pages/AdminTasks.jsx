...
const AdminTasks = () => {
  ...
  const searchTasks = useCallback(
    ...
    [accessToken, fetchTasks, pagination.pageSize],
  );
  ...
  const paginatedTasks = isSearchMode
    ? filteredTasks.slice(
  ...
  const displayTotal = isSearchMode ? filteredTasks.length : totalElements;
          ...
          <Col xs={24} lg={8}>
            ...
            >
              {isSearchMode && activeSearch
                ...
                : "Type to search — clear the box to see all tasks"}
            </Text>
          </Col>
