...
const SubscriptionPlanListDetailsCustomerId = () => {
  ...
  const fetchSubscriptionData = async () => {
    ...
    try {
      const response = await axios.post(
        "https://meta.oxyloans.com/api/erice-service/subscription-plans/getSubscriptionsDetailsForaCustomer",
        {
...
export default SubscriptionPlanListDetailsCustomerId;
