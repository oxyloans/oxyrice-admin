            ...
            <Row gutter={[16, 16]}>
              ...
              <Col xs={24} sm={12}>
                <Form.Item
                  ...
                  name="bagsCount"
                  rules={[
                    { required: true, message: "Please enter bags count" },
                  ]}
                >
              ...
              <Col xs={24} sm={12}>
                ...
                >
                  <Input
                    type="number"
                    placeholder="Enter return back count (if any)"
                  />
                </Form.Item>
              </Col>
              <Col xs={24} sm={12}>
                <Form.Item
                  ...
                  name="bagsDate"
                  rules={[
                    { required: true, message: "Please enter bags date" },
                  ]}
                >
              ...
              <Col xs={24} sm={12}>
                <Form.Item
                  ...
                  name="bagPrice"
                  rules={[
                    { required: true, message: "Please enter bag price" },
                  ]}
                >
              ...
              <Col xs={24} sm={12}>
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please enter total stock amount",
                    },
                  ]}
                >
