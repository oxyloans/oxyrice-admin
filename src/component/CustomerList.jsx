...
import { Table, Select, Button, Row, Col,Input, message, Pagination } from 'antd';
        ...
        >
         <Table.Column title="S.No" render={(text, record, index) => index + 1 + (currentPage - 1) * entriesPerPage}
          ...
          <Table.Column
            title="Subscriptions"
            align="center"
            render={(text, record) => <Link to="/subscription_plans/user_subscriptions_list"  size="small"  style={{
              backgroundColor: '#1C84C6',
              color: 'white',
          ...
          <Table.Column
            title="Orders"
            align="center"
            render={(text, record) => <Link to={`/orders/orders_list/${record.id}  `} size="small"   style={{
              backgroundColor: '#1C84C6',
              color: 'white',
