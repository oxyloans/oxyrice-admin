...
const SettingsForm = () => {
  ...
  const onFinish = async (values) => {
    ...
    const payload = {
      ...
      deliveryApplicableMinimumBillingAmount:
        values.deliveryApplicableMinimumBillingAmount,
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Form.Item
                ...
                name="deliveryApplicableMinimumBillingAmount"
              >
                <InputNumber min={0} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
            ...
            <Col span={12}>
              <Form.Item
                ...
                name="walletMaxTransactionAmount"
              >
                <InputNumber min={0} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
