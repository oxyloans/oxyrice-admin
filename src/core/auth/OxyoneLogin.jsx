  ...
  return (
    ...
    >
      ...
      >
        {/* Left Panel */}
        <div
          className="hidden sm:flex sm:w-1/2 flex-shrink-0 relative overflow-hidden"
          style={{
            minHeight: 420,
            backgroundImage:
              "url('https://i.ibb.co/TBXKZnQx/trimmed-left-design.png')",
        ...
        >
          ...
          <div className="relative z-10 flex h-full w-full items-start justify-center p-6">
            <div className="text-center pt-7">
              <div
                className="text-2xl font-black tracking-[0.22em] leading-none"
                style={{
                  color: "#e7f3ff",
                  textShadow: "0 0 20px rgba(112, 196, 255, 0.45)",
                }}
              >
                OXYONE
              </div>
              <div
                className="mt-2 text-[10px] font-semibold tracking-[0.28em] uppercase"
                style={{ color: "rgba(231,243,255,0.8)" }}
              >
                Portal
              </div>
            </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="mb-3">
                ...
                <div
                  className={`flex items-center rounded-xl border-[1.5px] transition-all ${email ? "border-slate-300 bg-white" : "border-slate-200 bg-slate-50"} focus-within:border-[#0a6fb4] focus-within:bg-white focus-within:shadow-[0_0_0_4px_rgba(10,111,180,.08)]`}
                >
                  <span className="pl-3 text-slate-400 flex-shrink-0 transition-colors focus-within:text-[#0a6fb4]">
                    <MailIcon />
                  </span>
                  <input
                    id="oxy-email"
              ...
              <div className="mb-1">
                ...
                <div
                  className={`flex items-center rounded-xl border-[1.5px] transition-all ${password ? "border-slate-300 bg-white" : "border-slate-200 bg-slate-50"} focus-within:border-[#0a6fb4] focus-within:bg-white focus-within:shadow-[0_0_0_4px_rgba(10,111,180,.08)]`}
                >
                  <span className="pl-3 text-slate-400 flex-shrink-0 focus-within:text-[#0a6fb4]">
                    <LockIcon />
                  </span>
                  <input
                    id="oxy-password"
                  ...
                  <button
                    ...
                    className="px-3 h-full text-slate-400 hover:text-[#0a6fb4] transition-colors cursor-pointer bg-transparent border-none flex items-center"
                  >
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: "0 10px 24px rgba(10,111,180,.28)",
                }}
              >
                <span
